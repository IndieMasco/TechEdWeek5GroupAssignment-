...
// app.get("/randomItem", function (request, response) {
//   const randomItem = items[Math.floor(Math.random() * items.length)]; // returns a single item from the array
//   response.json(randomItem);
//   //Will need to change this to a select query to pull from Supabase
